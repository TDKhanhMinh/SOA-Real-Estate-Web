...
export default function MySubscription() {
    ...
    const renderError = () => (
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-200 text-blue-700 px-8 py-10 rounded-2xl text-center shadow-lg">
            <div className="bg-white rounded-full p-5 w-24 h-24 mx-auto mb-6 shadow-lg">
                <HiOutlineXCircle className="w-14 h-14 text-blue-500" />
            </div>
    ...
    const renderNoSubscription = () => (
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-200 px-8 py-12 rounded-2xl text-center shadow-xl">
            <div className="bg-white rounded-full p-5 w-24 h-24 mx-auto mb-6 shadow-lg">
                <HiOutlineInformationCircle className="w-14 h-14 text-blue-500" />
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-8 max-w-2xl mx-auto">
                <div className="bg-white bg-opacity-80 backdrop-blur-sm p-4 rounded-xl shadow-md">
                    <HiSparkles className="w-8 h-8 text-blue-500 mx-auto mb-2" />
                    <p className="text-sm font-medium text-gray-700">Tính năng cao cấp</p>
                </div>
                <div className="bg-white bg-opacity-80 backdrop-blur-sm p-4 rounded-xl shadow-md">
                    <HiTrendingUp className="w-8 h-8 text-blue-500 mx-auto mb-2" />
                    <p className="text-sm font-medium text-gray-700">Hiệu quả tối ưu</p>
                </div>
                <div className="bg-white bg-opacity-80 backdrop-blur-sm p-4 rounded-xl shadow-md">
                    <HiShieldCheck className="w-8 h-8 text-blue-500 mx-auto mb-2" />
                    <p className="text-sm font-medium text-gray-700">Ưu tiên hỗ trợ</p>
                </div>
            </div>
                    ...
                    <div className="p-8 text-white relative">
                        ...
                        <div className="relative">
                            <div className="flex items-start justify-between mb-6">
                                <div>
                                    <div className="inline-block bg-white bg-opacity-20 backdrop-blur-sm px-4 py-1.5 rounded-full text-sm font-semibold mb-3">
                                        <HiShieldCheck className="w-4 h-4 inline-block mr-1 -mt-0.5" />
                                        ĐANG KÍCH HOẠT
                                    </div>
                    ...
                    <div className="p-8">
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div className="group bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border-2 border-blue-200 hover:border-blue-300 transition-all duration-200 hover:shadow-lg">
                                <div className="flex items-start gap-4">
                                    <div className="bg-blue-100 rounded-full p-3 group-hover:scale-110 transition-transform duration-200">
                                        <HiCurrencyDollar className="w-7 h-7 text-blue-600" />
                                    </div>
                                    <div>
                            ...
                            <div className="group bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border-2 border-blue-200 hover:border-blue-300 transition-all duration-200 hover:shadow-lg">
                                <div className="flex items-start gap-4">
                                    <div className="bg-blue-100 rounded-full p-3 group-hover:scale-110 transition-transform duration-200">
                                        <HiStar className="w-7 h-7 text-blue-600" />
                                    </div>
                                    <div>
